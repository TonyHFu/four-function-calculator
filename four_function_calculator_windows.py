...
class Calculator:
    ...
    def update_base(self):
        ...
        # Perform operation on first and second argument
    ...
    def handle_equal(self):
        ...
        equal_just_happened_and_stored_argument_and_operation = self.equal_just_happened and self.stored_argument is not None and self.stored_operation is not None

        first_equal_and_no_second_argument_yet = self.current_operation is not None and self.second_argument is None


        if equal_just_happened_and_stored_argument_and_operation or first_equal_and_no_second_argument_yet:
...
def calculate():
    ...
    while True:
        ...
        for key in command:
            ...
            if re.match(r"[/\*+-]", key):
                calculator.handle_operation(key)
